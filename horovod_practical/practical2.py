...
callbacks = [
    ...
    hvd.callbacks.LearningRateWarmupCallback(warmup_epochs=20, verbose=verbose),
...
if not data_augmentation:
    ...
    #fit the model on the batches generated by train/test_gen.flow()
...
# Score trained model.
scores = hvd.allreduce(model.evaluate_generator(test_iter , len(test_iter), workers=4))
if verbose:
